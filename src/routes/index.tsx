  ...
  return (
    <div>
      <section className="relative flex min-h-[92vh] items-center overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-[linear-gradient(105deg,color-mix(in_oklab,var(--sky-blue)_50%,transparent)_0%,color-mix(in_oklab,var(--navy)_50%,transparent)_48%,transparent_100%)]" />
